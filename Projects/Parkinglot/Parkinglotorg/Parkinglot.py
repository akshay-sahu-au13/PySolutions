...
class ParkingLot:
    ...
    def park_car(self,registration_no,color):
        if self.total_parked_slots < self.size: 
            ...
            self.slots[slot_no] = (registration_no, color)
    ...
    def leave(self,slot_no):
        ...
        if self.total_parked_slots > 0 and self.slots[slot_no-1] != (0, 0):
            self.slots[slot_no - 1] = (0, 0)
            self.total_parked_slots = self.total_parked_slots - 1
            return "Left"
        else:
    ...
    def view_parked_cars(self):
        ...
        for i in range(self.size):
            if self.slots[i] != (0, 0):
                print(f"{i+1} \t\t {self.slots[i][0]} \t\t {self.slots[i][1]}")
            else:
    ...
    def get_registration_no_by_color(self,color):
        ...
        for i in self.slots:
            ...
            if i[1].lower() == color.lower():
                registration_nos.append(i[0])
    ...
    def slot_numbers_by_reg_no(self,registration_no):
        ...
        for i in range(self.size):
            if self.slots[i][0] == registration_no:
                return i+1
            else:
                continue
        return -1
    ...
    def slot_numbers_by_color(self,color):
        ...
        for i in range(self.size):
            ...
            if self.slots[i] == (0,0):
                continue
            if self.slots[i][1].lower() == color.lower():
